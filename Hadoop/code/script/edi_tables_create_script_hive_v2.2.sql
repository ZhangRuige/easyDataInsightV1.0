...
-- 7.MODEL_MENTION
INSERT into TABLE EDI_M_MODEL_MENTION PARTITION(PT_DATE='20151215142010')
select A.brand_s,A.model_s,A.BRAND_m,A.model_m,count(1) as AMOUNT
FROM (

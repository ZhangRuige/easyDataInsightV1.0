...
--####LOAD DATA LOCAL INPATH '/opt/running/edi/data/new/product/part-r-00000' INTO TABLE EDI_M_PROD_INFO PARTITION (PT_DATE='20151214172010');
...
-- 8.MODEL_ALIAS
LOAD DATA LOCAL INPATH '/opt/running/edi/data/model_alias.txt' INTO TABLE EDI_M_MODEL_ALIAS;
